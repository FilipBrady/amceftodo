...
const UserProfileDashboard = () => {
  ...
  return (
    <div className='bg-white w-11/12 mx-auto lg:w-7/12 h-fit my-2 px-3 py-4 rounded-lg shadow-xl text-center flex sm:flex-row justify-between items-center mb-5 flex-col'>
      <div>
      ...
      <div className='flex flex-col gap-2 justify-between align-baseline'>
        ...
        <div className='modal'>
          <div className='modal-box'>
            <h3 className='font-bold text-lg text-white'>Add new Todo List.</h3>
            <AddToDoList />
